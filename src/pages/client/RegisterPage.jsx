    ...
    <div className="auth-page-grid" style={{
      ...
      <div className="auth-left-banner" style={{
        ...
        <div>
          <div className="hero-badge" style={{ marginBottom: '16px' }}>
            <Gift size={14} /> Ưu đãi độc quyền cho thành viên mới
          </div>
          <h2 style={{ fontSize: '38px', fontWeight: '800', lineHeight: '1.2', marginBottom: '16px' }}>
            Hãy Đăng Ký Tài Khoản <br /> Để Nhận Ưu Đãi! 🎁
          </h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '15px', lineHeight: '1.6', maxWidth: '440px' }}>
            Tặng ngay <b>5,000 Tokens miễn phí</b> khi tạo tài khoản mới. Trải nghiệm tạo giọng đọc trí tuệ nhân tạo siêu thực ngay hôm nay.
          </p>
        </div>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '420px' }}>
          ...
          <h2 style={{ fontSize: '28px', fontWeight: '800', marginBottom: '8px' }}>Tạo Tài Khoản Mới</h2>
          ...
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            <div>
              <label style={{ fontSize: '12.5px', fontWeight: '700', color: 'var(--text-secondary)', display: 'block', marginBottom: '8px' }}>HỌ VÀ TÊN</label>
          ...
          <div style={{ display: 'flex', alignItems: 'center', margin: '24px 0', color: 'var(--text-secondary)', fontSize: '12px' }}>
            ...
            <span style={{ padding: '0 12px' }}>HOẶC ĐĂNG KÝ BẰNG GOOGLE</span>
            <div style={{ flex: 1, height: '1px', background: 'var(--border-color)' }}></div>
          </div>

          {/* Nút Đăng Ký Google Nằm Ở Dưới Cùng */}
